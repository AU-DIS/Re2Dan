...
corpora = ['TED2020', 'WikiMatrix', 'ELRC-848-laegemiddelstyrelsen', 'ELRC-EMEA', 'ELRC-2877-EU_publications_medi']  #Corpora you want to use
source_languages = ['en']            #Source language, our teacher model is able to understand
target_languages = ['da']    #Target languages, out student model should learn
